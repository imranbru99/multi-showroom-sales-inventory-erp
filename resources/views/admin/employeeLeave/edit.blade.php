...
@section('card_body')
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <input class="form-control" type="hidden" name="employeeLeaveId" value="{{ $employeeLeave->id }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="form-group {{ $errors->has('employeeId') ? ' has-danger' : '' }}">
                    ...
                    <input class="form-control" type="text" name="employeeName" value="{{ $employeeLeave->employeeName }} ({{ $employeeLeave->employeeNo }})" readonly>
                    <input class="form-control" type="hidden" id="employeeId" name="employeeId" value="{{ $employeeLeave->employee_id }}">
                </div>
            </div>
                ...
                <div class="form-group {{ $errors->has('leaveId') ? ' has-danger' : '' }}">
                    ...
                    <select class="form-control chosen-select leave" name="leaveId">
                        ...
                        @foreach ($leaves as $leave)
                            @php
                                if ($leave->id == $employeeLeave->leave_id)
                                {
                                    $select = "selected";
                                }
                                else
                            ...
                            @endphp
                            <option value="{{ $leave->id }}" {{ $select }}>{{ $leave->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-2 form-group">
                ...
                <input  type="text" class="form-control datepicker" id="fromDate" name="fromDate" value="{{ date('d-m-Y', strtotime($employeeLeave->from_date)) }}" placeholder="Select From Date" onchange="totalDays()" readonly>
            </div>

            <div class="col-md-2 form-group">
                <label for="to-date">To Date</label>
                <input  type="text" class="form-control datepicker" id="toDate" name="toDate" value="{{ date('d-m-Y', strtotime($employeeLeave->to_date)) }}" placeholder="Select To Date" onchange="totalDays()" readonly>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('previousLeaveDays') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control" id="previousLeaveDays" name="previousLeaveDays" placeholder="Previous Leave Days" value="{{ $previousLeaveDays->totalDays }}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('leaveDays') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control" id="leaveDays" name="leaveDays" placeholder="Leave Days" value="{{ $employeeLeave->days }}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('observedDays') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control" id="observedDays" name="observedDays" placeholder="Total Observed Leave Days" value="{{ $employeeLeave->total_observe_leave_days }}" readonly>
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('remainingDays') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control" id="remainingDays" name="remainingDays" placeholder="Total Remaining Leave Days" value="{{ $employeeLeave->total_remain_leave_days }}" readonly>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('remarks') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control" name="remarks" placeholder="Remarks" rows="5">{{ $employeeLeave->remarks }}</textarea>

...
<div class="card-body">
    ...
    <div class="row d-flex justify-content-between mb-3" style="min-height: 85px;">
        ...
        <div class="col-md-3" id="serialOption">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="form-group {{ $errors->has('serialNo') ? ' has-danger' : '' }}">
                        <input type="text" class="form-control" name="serialNo" value="{{ $serialNo }}" required
                               readonly />
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group {{ $errors->has('voucharNo') ? ' has-danger' : '' }}">
                        <input type="text" class="form-control" name="voucharNo" value="{{ old('voucharNo') }}"
                               required>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label for="store-showroom">Store</label>
            ...
            <div class="row">
                <div class="col-md-9 productColumn">
                ...
                <div class="col-md-3" id="rateColumn" style="display: none;">
            ...
            <div class="row" id="partsPTable" style="display: none">
                <div class="col-md-12">
                    <label for=""></label>
                    <div class="form-group">

                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control chosen-select" name="districtId" id="districtId">
                            ...
                            <option value="{{ $district->id }}" @if ($district->id == $dealer->region_id) selected @endif>{{ $district->name }} /
                                {{ $district->bangla_name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group {{ $errors->has('short_name') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="short_name" value="{{ $dealer->short_name }}"
        ...
        <div class="col-md-2">
            <div class="form-group {{ $errors->has('commission') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="commission" value="{{ $dealer->commission }}"
                       required>

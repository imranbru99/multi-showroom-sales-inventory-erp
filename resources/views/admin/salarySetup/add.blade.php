    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('cut_on') ? ' has-danger' : '' }}">
                ...
                <input type="number" class="form-control" name="cut_on" value="{{ old('cut_on') }}" placeholder="3 Days Late">
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('salary_cut') ? ' has-danger' : '' }}">
                ...
                <input type="number" class="form-control" name="salary_cut" value="{{ old('salary_cut') }}" required placeholder="1 Day Salary Cut">

...
<div class="row">
    ...
    <span class="shortlink">
         ...
         <a class="btn btn-info" onclick="return confirm('Are you sure want to delete')"  href="{{ route('menu.delete',$menu->id) }}">Delete</a>
         <a class="btn btn-info"  href="{{ route('menuadd.page') }}">Add New</a>

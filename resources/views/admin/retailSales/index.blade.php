        ...
        $(document).ready(function() {
            ...
            $(function() {
                ...
                var table = $('#dtbwyj').DataTable({
                    ...
                    processing: false,
                    serverSide: true,
                    ajax: "{{ route('retailSales.index') }}?project={{ $project_id }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex',
                            orderable: false,
            ...
            $('#dtbwyj tbody').on('click', 'i.fa-trash', function() {
                ...
                retailSalesId = $(this).parent().data('id');
                var tableRow = this;
                swal({
                        title: "Are you sure?",
    ...
    <script>
        $(function() {
            $('#project').change(function(e) {
                ...
                window.location.href = '{{ route('retailSales.index') }}' + "?project=" +
                    project;

...
@section('card_body')
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="form-group {{ $errors->has('purchaseType') ? ' has-danger' : '' }}">
                    <select name="purchaseType" id="purchaseType" class="form-control purchaseType chosen-select">
            ...
            <div class="col-md-3">
                <div class="form-group {{ $errors->has('dealerId') ? ' has-danger' : '' }}">
                    ...
                    <select class="form-control chosen-select select_project dealerId" name="dealerId"
                        @if ($showroomId == 1) required="" @endif>
                        <option value="">Select Showroom Project Name</option>
                        @foreach ($showroomProjects as $showroomProject)
                            <option value="{{ $showroomProject->id }}" @if($showroomProject->id == $project_id) selected @endif>{{ $showroomProject->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-3">
                <div class="form-group {{ $errors->has('store') ? ' has-danger' : '' }}">
                    <label for="showroom-id">Store</label><span style="color: red; font-size: 18px;">*</span>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div id="customerId" class="form-group {{ $errors->has('customerId') ? ' has-danger' : '' }}">
                    ...
                    <select class="form-control chosen-select customer" name="customerId"
                        ...
                        @foreach ($customers as $customer)
                            <option value="{{ $customer->id }}">{{ $customer->code }} ({{ $customer->name }})
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('customerName') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control customerName" id="customerName" name="customerName"
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('customerPhone') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control customerPhone" id="customerPhone" name="customerPhone"
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="nick-name">Invoice No / MR.No</label>
                            <input type="text" class="form-control" name="invoice_no" value="{{ $invoiceNo }}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group {{ $errors->has('referenceId') ? ' has-danger' : '' }}">
                            ...
                            <select class="form-control chosen-select referenceId" name="referenceId" required>
            ...
            <div class="col-md-8">
                <div class="form-group {{ $errors->has('productUsageAddress') ? ' has-danger' : '' }}">
                    <label for="product-usage-address">Delivery Address</label>
                    <textarea name="productUsageAddress" class="form-control" rows="4"></textarea>
        ...
        <div class="product-block short_long_installment" id="1">
            ...
            <div class="row p-3 mt-3" style="border: 1px solid black">
                ...
                <div class="col-md-2">
                    <div class="form-group {{ $errors->has('cashPrice') ? ' has-danger' : '' }}">
                        ...
                        <input type="number" min="0" name="cashPrice[]" class="form-control cashPrice cashPrice_1"
                            oninput="cash_row_sum(1)" value="0" step=".1">
                ...
                <div class="col-md-3">
                    <div class="form-group {{ $errors->has('salesPrice') ? ' has-danger' : '' }}">
                        ...
                        <input type="number" min="0" name="salesPrice[]" class="form-control salesPrice salesPrice_1"
                            value="0">
        ...
        <div class="row">
            ...
            <div class="col-md-3 shortInstallmentRow">
            ...
            <div class="col-md-3 shortInstallmentRow">
                <div class="form-group {{ $errors->has('shortInstallmentDeposite') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" class="form-control shortInstallmentDeposite"
                        name="shortInstallmentDeposite" value="0" oninput="calculateInstallmentDueAmount(null, event)">
            ...
            <div class="col-md-3 longInstallmentRow">
            ...
            <div class="col-md-3 longInstallmentRow">
                <div class="form-group {{ $errors->has('longInstallmentDeposite') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" class="form-control longInstallmentDeposite"
                        name="longInstallmentDeposite" value="0" oninput="calculateInstallmentDueAmount(null, event)">
            ...
            <div class="col-md-3 longInstallmentRow">
                <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control longInstallmentSavings savings"
                        name="longInstallmentSavings" value="0" readonly>
                </div>
            </div>
            ...
            <div class="col-md-3 shortInstallmentRow">
                <div class="form-group">
                    <label for="savings">Savings Amount</label>
                    <input type="number" min="0" class="form-control shortInstallmentSavings savings"
                        name="shortInstallmentSavings" value="0" readonly>
                </div>
            </div>
            ...
            <div class="col-md-3 shortInstallmentRow">
                <div class="form-group {{ $errors->has('shortInstallmentDueAmount') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" class="form-control shortInstallmentDueAmount"
                        name="shortInstallmentDueAmount" value="0">
            ...
            <div class="col-md-3 longInstallmentRow">
                <div class="form-group {{ $errors->has('longInstallmentDueAmount') ? ' has-danger' : '' }}">
                    <label for="deposite">Due Amount</label>
                    <input type="number" min="0" class="form-control longInstallmentDueAmount longDueAmount"
            ...
            <div class="col-md-3 installmentType">
                <div class="form-group {{ $errors->has('installmentType') ? ' has-danger' : '' }}">
                    ...
                    @php
                        $installmentTypes = ['Daily' => 'Daily', 'Weekly' => 'Weekly', 'Bi-Monthly' => 'Bi-Monthly', 'Monthly' => 'Monthly'];
                    @endphp
                    <select class="form-control installment_type" name="installmentType">
            ...
            <div class="col-md-3 shortInstallmentRow">
                <div class="form-group {{ $errors->has('shortTotalInstallment') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" class="form-control shortTotalInstallment" name="shortTotalInstallment"
                        value="0" oninput="calculateShortInstallmentAmount(null, event)" readonly>
            ...
            <div class="col-md-3 longInstallmentRow">
                <div class="form-group {{ $errors->has('longTotalInstallment') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" class="form-control longTotalInstallment" name="longTotalInstallment"
                        value="0" oninput="calculateLongInstallmentAmount(null, event)" readonly>
        ...
        <div class="guarantorInfo p-3">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-center" style="font-weight: bold;font-family: tahoma">Guarantor Information 1</h4>
                </div>
            </div>
                ...
                <div class="col-md-3">
                    <div class="form-group {{ $errors->has('guarantorProfessionName') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" class="form-control" name="guarantorProfessionName[]"
                            value="{{ old('guarantorProfessionName') }}">
                ...
                <div class="col-md-3">
                    <div class="form-group {{ $errors->has('guarantorDesignation') ? ' has-danger' : '' }}">
                        ...
                        <input type="text" class="form-control" name="guarantorDesignation[]"
                            value="{{ old('guarantorDesignation') }}">
        ...
        <div class="guarantorInfo p-3">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="text-center" style="font-weight: bold;font-family: tahoma">Guarantor Information 2</h4>
                </div>
            </div>
...
@section('custom-js')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.shortInstallmentDeposite').keyup(function(e) {
                ...
                var savings = thisParent.find('.shortInstallmentSavings').val();

                let depositAmount = $(this).val();

                let thisMRP = thisParent.find('.shortInstallmentPrice').val();

                let due = thisMRP - (parseInt(depositAmount) + parseInt(savings));
            ...
            $('.longInstallmentDeposite').keyup(function(e) {
                ...
                var savings = thisParent.find('.longInstallmentSavings').val();

                let depositAmount = $(this).val();
                let thisHaire = thisParent.find('.longInstallmentPrice').val();

                let due = thisHaire - (parseInt(depositAmount) + parseInt(savings));
    ...
    <script type="text/javascript">
            ...
            if (customerId != '') {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('.savings').val(data.customerSavings.totalSavings);
                        //                        $('.longInstallmentSavings').val(data.customerSavings.totalSavings);
                        //                        $('.shortInstallmentSavings').val(data.customerSavings.totalSavings);
                    }
                });
            } else {
                $('.customerName').val("");
        ...
        function calculateInstallmentDueAmount(parent, e) {
            ...
            if (purchaseType == "Cash") {
                ...
                var savings = parseInt(parent.find('.shortInstallmentSavings').val());

                var dueAmount = price - deposite - discount - giftVoucher - exchangeCrt - savings;
                ...
                var savings = parseInt(parent.find('.longInstallmentSavings').val());
        ...
        $('.installment_type').change(function() {
            ...
            var short_install = $('.shortInstallmentDueAmount').val();
            var long_install = $('.longInstallmentDueAmount').val();


            console.log(short_install);
            console.log(long_install);
            if (type == 'Daily') {
                var total_short_install = parseInt(short_install) / 300;
                var total_long_install = parseInt(long_install) / 300;

                $('.shortTotalInstallment').val(300);
                $('.longTotalInstallment').val(300);
                $('.shortInstallmentAmount').val(Math.ceil(total_short_install));
                $('.longInstallmentAmount').val(Math.ceil(total_long_install));
            }

            if (type == 'Weekly') {

                var total_short_install = parseInt(short_install) / 50;
                var total_long_install = parseInt(long_install) / 50;

                $('.shortTotalInstallment').val(50);
                $('.longTotalInstallment').val(50);
                $('.shortInstallmentAmount').val(Math.ceil(total_short_install));
                $('.longInstallmentAmount').val(Math.ceil(total_long_install));
            }
            ...
            if (type == 'Bi-Monthly') {
                ...
                var total_short_install = parseInt(short_install) / 24;
                var total_long_install = parseInt(long_install) / 24;

                $('.shortTotalInstallment').val(24);
                $('.longTotalInstallment').val(24);
                $('.shortInstallmentAmount').val(Math.ceil(total_short_install));
                $('.longInstallmentAmount').val(Math.ceil(total_long_install));
            }
            ...
            if (type == 'Monthly') {
                ...
                var total_short_install = parseInt(short_install) / 12;
                var total_long_install = parseInt(long_install) / 12;

                $('.shortTotalInstallment').val(12);
                $('.longTotalInstallment').val(12);
                $('.shortInstallmentAmount').val(Math.ceil(total_short_install));
                $('.longInstallmentAmount').val(Math.ceil(total_long_install));
            }
    ...
    <script>
        ...
        $(".buttonAddEdit").click(function(e) {
            ...
            if (dealerId != '' && referenceId != '' && customerId != '') {
                $('#formAddEdit').submit();
            }
        });
    </script>

					...
					<table class="table table-bordered table-sm productTable">
					    ...
					    <tbody>
					        <tr>
					            ...
					            <td>{{ @$retailSales->customerCode }}</td>
					        </tr>
					        <tr>
					        	<td class="info_head" width="100px">Name</td>
					            <td>{{ @$retailSales->customerName }}</td>
					        </tr>
					        <tr>
					        	<td class="info_head" width="100px">Contact</td>
					            <td>{{ @$retailSales->customerPhone }}</td>
					        </tr>
					        <tr>
					        	<td class="info_head" width="100px">Address</td>
					            <td>{{ @$retailSales->customerPresentAddress }}</td>
					        </tr>
					    </tbody>
					</table>
				</div>
					...
					<table class="table table-bordered table-sm productTable">
					    ...
					    <tbody>
					        ...
					        <tr>
					            ...
					            <td>{{ @$retailSales->purchase_type }}</td>
					        </tr>
					        @if (@$retailSales->purchase_type == "Cash")
						        <tr>
						        	<td class="info_head" width="200px">Cash Price</td>
						            <td>{{ @$retailSales->cash_price }}</td>
						        </tr>
					        @else
					        	@if (@$retailSales->purchase_type == "Short Installment")
							        <tr>
							        	<td class="info_head" width="200px">MRP Price</td>
							            <td>{{ @$retailSales->mrp_price }}</td>
							        </tr>
					        	@else
							        <tr>

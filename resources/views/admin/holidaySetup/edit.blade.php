        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('holidayFor') ? ' has-danger' : '' }}">
                            <label for="holiday-for">Holiday For</label>
                            <select class="form-control" id="holidayFor" name="holidayFor">
                                <option value="">Select Holiday For</option>
                                @foreach ($holidayFor as $key => $value)
                                    @php
                                        if ($key == $holiday->holiday_for)
                                        {
                                            $select = "selected";
                                        }
                                        else
                            ...
                            @if ($errors->has('holidayFor'))
                                @foreach($errors->get('holidayFor') as $error)
                                    <div class="form-control-feedback">{{ $error }}</div>
                                @endforeach
                            @endif
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4 form-group">
                        <label for="from-date">From Date Of Holiday</label>
                    ...
                    <div class="col-md-4 form-group">
                        <label for="to-date">To Date Of Holiday</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('numberOfDay') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control" id="numberOfDay" name="numberOfDay" value="{{ $holiday->days }}" readonly>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control" name="description" rows="9" placeholder="Holiday Description...">{{ $holiday->description }}</textarea>

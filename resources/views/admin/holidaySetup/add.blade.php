        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group {{ $errors->has('numberOfDay') ? ' has-danger' : '' }}">
                            ...
                            <input type="number" class="form-control" id="numberOfDay" name="numberOfDay" value="{{ old('numberOfDay') }}" readonly>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <textarea class="form-control" name="description" rows="9" placeholder="Holiday Description...">{{ old('description') }}</textarea>

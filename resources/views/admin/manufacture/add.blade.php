        ...
        <div class="row">
                    ...
                    <label for="employee-id">Product Name</label>
                     <select class="form-control chosen-select product" name="productId">
                        ...
                        @foreach ($products as $product)
                            <option value="{{ $product->id }}">{{ $product->name }} ( {{ $product->code }} - {{ $product->color }} - {{ $product->model_no }} 
                            )</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group {{ $errors->has('catagoryId') ? ' has-danger' : '' }}">
                    ...
                    <select class="form-control chosen-select catagory" name="catagoryId">
                        ...
                        @foreach ($catgoires as $catgoire)
                            <option value="{{ $catgoire->id }}">{{ $catgoire->name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('prouductionUnit') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="prouductionUnit" name="prouductionUnit" placeholder="Production Unit" value="" >
               ...
               @endif
                ...
                <div class="form-group {{ $errors->has('requiredUnit') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="requiredUnit" name="requiredUnit" placeholder="required Unit" value="" >
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('partsAmount') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="partsAmount" name="partsAmount" placeholder="amount" value="" >

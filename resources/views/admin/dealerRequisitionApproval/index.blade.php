                    ...
                    <table class="table table-bordered table-sm detailRequisitionProduct">
                        <thead>
                            <tr>
                                ...
                                <th width="100px">Suggested Qty</th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><input style="text-align: right;" class="form-control totalSuggestedQty"
                                        id="totalSuggestedQty" type="number" name="totalSuggestedQty" value="" readonly>
                                </td>
                                <td><input style="text-align: right;" class="form-control totalSuggestionAmount"
                                        ...
                                        readonly></td>
                                <td><input style="text-align: right;" class="form-control totalApproveQty"
                                        id="totalApproveQty" type="number" name="totalApproveQty" value="0" readonly>
                                </td>
                                <td><input style="text-align: right;" class="form-control totalApproveAmount"
                                        id="totalApproveAmount" type="number" name="totalApproveAmount" value="0"
                                        readonly></td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        function showDetailRequisition(dealerRequisitionId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (dealerRequisition.approved_qty != null)
                    {
                        $('.totalApproveQty').val(dealerRequisition.approved_qty);
                    }

                    if (dealerRequisition.suggested != null)
                    {
                        $('.totalSuggestedQty').val(dealerRequisition.suggested);
                    }

                    if (dealerRequisition.approved_amount != null)
                    {
                        $('.totalApproveAmount').val(dealerRequisition.approved_amount);
                    }
                    ...
                    let totalApproveQty = 0;
                    let totalApproveAmt = 0;
                    ...
                    for (var dealerRequisitionProduct of dealerRequisitionProducts)
                    {
                        ...
                        $(".detailRequisitionProduct tbody").append(
                            '<tr class="requisitionProductRow" id="requisitionProductRow_'+dealerRequisitionProduct.id+'">' +
                                ...
                                '</td>'+
                                '<td>'+
                                    '<input style="text-align: right;" class="form-control SuggestionQty SuggestionQty_'+dealerRequisitionProduct.id+'" oninput="rowSum(); getsuggestionAmount(event)" type="text" name="SuggestionQty[]" value="'+dealerRequisitionProduct.suggested_qty+'" readonly>'+
                                '</td>'+
                                '<td>'+
                                '<input style="text-align: right;" class="form-control SuggestionAmount SuggestionAmount_'+dealerRequisitionProduct.id+'" oninput="rowSum()" type="text" name="SuggestionAmount[]" value="'+suggestedAmount+'" readonly>'+
                                '</td>'+
                                '<td>'+
                    ...
                    $('#totalApproveAmount').val(totalApproveAmt);

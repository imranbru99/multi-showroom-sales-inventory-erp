    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('date') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control datepicker" name="loan_date" value="{{ date('d-m-Y') }}" required>
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('loan_no') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="loan_no" id="loan_no" value="{{ old('loan_no') }}" required>
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('loan_amount') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="loan_amount" id="loan_amount" value="{{ old('loan_amount') }}" oninput="calculatePayableAmount()" required>
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('interest') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="interest" id="interest" value="{{ old('interest') }}" oninput="calculatePayableAmount()" required>
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('total_amount') ? ' has-danger' : '' }}">
                <label for="code-prefix">Total Payable Amount</label>
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('total_installment') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="total_installment" id="total_installment" oninput="divideInstallmentAmount();" value="{{ old('total_installment') }}" required>
        ...
        <div class="col-md-4">
            <div class="form-group {{ $errors->has('insatllment_amount') ? ' has-danger' : '' }}">
                ...
                <input type="text" class="form-control" name="insatllment_amount" id="insatllment_amount" value="{{ old('insatllment_amount') }}" required>

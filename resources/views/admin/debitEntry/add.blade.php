    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    <select class="chosen-select" id="creditAccountHead" name="creditAccountHead" required="">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('voucharNo') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="voucharNo" name="voucharNo" value="{{ $voucherNo }}" placeholder="Select Showroom For Generate Voucher No" readonly>
                    ...
                    <table class="table table-bordered table-striped gridTable" >
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td><input style="text-align: right" type="number" class="totalDebit" id="totalDebit" name="totalDebit" value="0" readonly></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>

    ...
    <div class="row">
        <div class="col-md-3">
            ...
            <div class="form-group {{ $errors->has('requisitionNo') ? ' has-danger' : '' }}">
                <input type="text" class="form-control" name="requisitionNo" value="{{ $requisitionNo }}" required
                    readonly />
        ...
        <div class="col-md-3">
            ...
            <div class="form-group {{ $errors->has('requisitionDate') ? ' has-danger' : '' }}">
                <input type="text" class="form-control add_datepicker" name="requisitionDate"
                    value="{{ old('requisitionDate') }}" readonly>
        ...
        <div class="col-md-6">
            <label for="dealer">Dealer</label> <label for="selUIJ" generated="true" class="error" style="display: inline;">*</label>
            <div class="form-group {{ $errors->has('dealerId') ? ' has-danger' : '' }}">
                <select class="form-control chosen-select" name="dealerId" required="required">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group {{ $errors->has('product') ? ' has-danger' : '' }}">
                <select class="form-control chosen-select product" id="product" name="product">
                    ...
                    <option value="{{$product->id}}">{{ $product->name }} ( {{ $product->code }} - {{ $product->color }}

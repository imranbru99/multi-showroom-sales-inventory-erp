@extends('admin.layouts.masterAddEditSalesReturn')
...
@section('card_body')
    ...
    <div class="card-body">
        <div class="row">
            ...
            <input type="hidden"  name="sales_by" value="{{ $productIssue->sales_by }}">
            <input type="hidden"  name="id" value="{{ $sale->id }}">
            <input type="hidden"  name="serial_no" value="{{ $sale->serial_no }}">
            <input type="hidden"  name="issue_id" value="{{ $sale->issue_id }}">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group {{ $errors->has('productIssueNo') ? ' has-danger' : '' }}">
                    <input type="text" class="form-control" name="productIssueNo" value="{{ $returnNo }}" required readonly>
        ...
        <div class="row">
             <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="text" class="form-control"  value="{{ $dealerName }}" readonly>
                    <input type="hidden" class="form-control" name="dealer_id" value="{{ $productIssue->dealer_id }}">
                </div>
            </div>
            <div class="col-md-6">
                <label for="dealer-address">Dealer Address</label>
                <div class="form-group">
                    <input class="form-control" id="dealerAddress" name="dealerAddress" rows="5" value = "{{ $dealerAddress }}">
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <table class="table table-bordered table-striped table-sm issueProductList" >
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>                
                                    ...
                                    <td>
                                        <input style="text-align: right;"  type="number" name="productPrice" value="{{ $sale->price }}"  readonly>
                                    </td>

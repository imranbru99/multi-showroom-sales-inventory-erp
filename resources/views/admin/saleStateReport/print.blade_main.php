        ...
        <table id="report-table" name="paymentRecordTable" class="table table-bordered table-sm">
            <thead>
                <tr>
                    ...
                    <th width="70px">Collection Ratio %</th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                @foreach ($data as $d)
                    @php
                        ...
                        if (!empty($d['actualSale'])) {
                        $percent = 100 - (($d['actualSale'] - $d['collection']) / $d['actualSale']) * 100;
            ...
            <tfoot>
                @php
                    ...
                    $creditP = $totalPercent/count($data);

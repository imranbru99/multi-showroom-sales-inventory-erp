...
@section('card_body')
    ...
    @php
        ...
        $maxDealerRequisitionId = ProductionRequisition::max('id');
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                ...
                <div class="form-group {{ $errors->has('productQty') ? ' has-danger' : '' }}">
                    <input type="number" class="form-control" id="productQty" name="productQty" value="{{ old('productQty') }}" >
                  ...
                  <div class="form-group {{ $errors->has('requisitionNameId') ? ' has-danger' : '' }}">
                    ...
                    <select class="form-control chosen-select employee" name="requisitionNameId">
                        ...
                        @foreach ($req_name as $req_nam)
                            <option value="{{ $req_nam->id }}">{{ $req_nam->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    <table class="table table-bordered table-striped gridTable" >
                        ...
                        <tbody id="tbody">
                            ...
                            <tfoot>                                
                                <tr>
                                    <td align="right" ><p style="font-size: 14px; font-weight: bold; padding-right: 5px;">Total Quantity</p></td>

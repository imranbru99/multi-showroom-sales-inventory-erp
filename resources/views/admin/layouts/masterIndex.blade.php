                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    @if (Route::currentRouteName() == 'customerRegistration.index')
                                    <a style="font-size: 16px;" class="btn btn-outline-info btn-lg"
                                       href="{{ route('customerRegistration.print.all') }}">
                                        <i class="fa fa-print"></i> Print
                                    </a>
                                    @endif

                                    @if (Route::currentRouteName() == 'dealerSetup.index')
                                    <a style="font-size: 16px;" class="btn btn-outline-info btn-lg"
                                       href="{{ route('dealerSetup.print') }}" target="_blank">
                                        <i class="fa fa-print"></i> Print
                                    </a>
                                    @endif

                                    <a style="font-size: 16px;" class="btn btn-outline-info btn-lg add_new"
                                       href="{{ route($addNewLink) }}">

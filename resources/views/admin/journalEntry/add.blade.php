...
@section('card_body')
    <div class="card-body">
        <div class="row">
            {{-- <div class="col-md-6">
                <label for="showroom">Company </label>
                <div class="form-group">
                    <select class="form-control chosen-select" id="showroom" name="showroom" required>
            ...
            <div class="col-md-6">
                <div class="form-group {{ $errors->has('voucharNo') ? ' has-danger' : '' }}">
                    ...
                    <input type="text" class="form-control" id="voucharNo" name="voucharNo" value="{{ $voucherNo }}"
                        placeholder="Enter Vouchar No" required>
                    ...
                    <table class="table table-bordered table-striped gridTable">
                        ...
                        <tbody id="tbody">
                            <tr>
                                ...
                                <td>
                                    <input style="text-align: right;" class="debit debit_1" id="debit" name="debit[]"
                                        oninput="findTotal()" value="0">
                                </td>

                                <td>
                                    <input style="text-align: right;" class="credit credit_1" id="credit" name="credit[]"
                                        oninput="findTotal()" value="0">
                                </td>
...
@section('custom-js')
    <script type="text/javascript">
        ...
        function removeItem(i) {
            ...
            if (totalDebit != totalCredit) {
                $("#btn_buttonAddEdit").attr("disabled", true);
            } else {
                $("#btn_buttonAddEdit").attr("disabled", false);
            }

...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" data-toggle="tab" href="#dealerInformation"
            style="font-weight: bold;">Information</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content">
    <div id="dealerInformation" class="tab-pane active p-0">
        ...
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('dealerSetup.update') }}" method="POST"
                enctype="multipart/form-data" id="" name="">
                {{ csrf_field() }}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control chosen-select" name="districtId" id="districtId">
                                    ...
                                    @php
                                    if ($district->id == $dealer->region_id) {
                                    $select = 'selected';
                                    } else {
                                    $select = '';
                                    }
                                    ...
                                    @endphp
                                    <option value="{{ $district->id }}" {{ $select }}>{{ $district->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group" id="upazila-select-menu">
                                <select class="form-control chosen-select" name="upazilaId" id="upazilaId">
                                    ...
                                    @endphp
                                    <option value="{{ $upazila->id }}" {{ $select }}>{{ $upazila->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('territoryId') ? ' has-danger' : '' }}">
                                ...
                                <select class="form-control" name="territoryId">
                                    ...
                                    @endphp
                                    <option value="{{ $territory->id }}" {{ $select }}>{{ $territory->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            @php
                            $dealerTypes = $dealerTypes = $dealerTypes = [
                            'Internal' => 'Internal',
                            'External' => 'External',
                            ];
                            @endphp
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('dealerName') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" class="form-control" name="dealerName" value="{{ $dealer->name }}"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('short_name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" class="form-control" name="short_name"
                                    value="{{ $dealer->short_name }}" maxlength="20" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('contactPerson') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" class="form-control" name="contactPerson"
                                    value="{{ $dealer->contact_person }}" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('mobile') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" class="form-control" name="mobile" value="{{ $dealer->mobile }}"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('reference') ? ' has-danger' : '' }}">
                                ...
                                <select name="reference" class="form-control chosen-select">
                                    ...
                                    <option value="{{ $staff->id }}" @if($staff->id == $dealer->reference_by) selected
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('title') ? ' has-error' : '' }}">
                                <input type="text" class="form-control" name="title" value=""
                                    placeholder="Document Title" id="docTitle">
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group {{ $errors->has('document') ? ' has-error' : '' }}">
                                <input type="file" class="form-control" aria-describedby="fileHelp" name="document"
                                    id="dealerDoc">
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="document" class="table table-bordered table-striped documents">
                                ...
                                <tbody>
                                    ...
                                    <tr id="doc_{{ $document->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('dealerDocument.download', $document->id) }}"
                                                data-toggle="tooltip" data-original-title="Download"> <i
                                                    class="fa fa-download m-r-10"></i> </a>
                                            <a href="{{ route('dealerDocument.view', $document->id) }}"
                                                data-toggle="tooltip" data-original-title="View" target="_blank"> <i
                                                    class="fa fa-eye text-success m-r-10"></i> </a>
                                            <a href="javascript:void(0)" data-toggle="tooltip"
                                                data-original-title="Delete" class=""
                                                onclick="removeDocument({{ $document->id }})" style="width: 100%;"><i

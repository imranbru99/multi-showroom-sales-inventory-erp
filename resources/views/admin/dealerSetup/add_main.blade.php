...
{{-- <div class="card-body"> --}}
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" data-toggle="tab" href="#informations" style="font-weight: bold;">Information</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#documents" style="font-weight: bold;">Documents</a>
        </li>
    </ul>

    <div class="tab-content">
        <div id="informations" class="container tab-pane active">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group {{ $errors->has('creditLimit') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" class="form-control" name="creditLimit" value="0" @if(auth()->user()->role != 1) readonly @endif>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('document') ? ' has-danger' : '' }} ml-4">
                                        <div><label for="gender">Document</label></div>
                                        <div class="mt-2">
                                            <input type="radio" class="form-control_" value="1" name="document" checked> Yes
                                            <input type="radio" class="form-control_ ml-2" value="0" name="document"> No
                                        </div>
                                    </div>
                                </div>

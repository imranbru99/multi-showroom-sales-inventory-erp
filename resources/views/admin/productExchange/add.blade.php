...
<div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="invoice_no" value="" placeholder="Invoice No" id="invoice_no">
                        <input type="hidden" class="form-control" value="" name="saleType" id="saleType">
                        <input type="hidden" class="form-control" name="saleId" value="" id="saleId">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control add_datepicker" name="date" value="{{ date('d-m-Y', strtotime(now())) }}">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="text-center py-3" style="font-weight: bold;font-family: tahoma; background-color: #ddd;">Old Product</h4>
        </div>
    </div>

    <table class="table table-bordered mt-2" id="return">
        <thead>
            <tr>
                <th>Sale Date</th>
                <th>Product Name</th>
...
<div class="card-body">
    ...
    <div class="row mb-4">
        <div class="col-md-12">
            <h4 class="text-center py-3" style="font-weight: bold;font-family: tahoma; background-color: #ddd;">New Product</h4>
        </div>
    </div>
        ...
        <div class="row p-3 mt-3" style="border: 1px solid black">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('cashPrice') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" name="cashPrice[]" class="form-control cashPrice cashPrice_1" oninput="cash_row_sum(1)" value="0" step=".1">
            ...
            <div class="col-md-4">
                <div class="form-group {{ $errors->has('salesPrice') ? ' has-danger' : '' }}">
                    ...
                    <input type="number" min="0" name="salesPrice[]" class="form-control salesPrice salesPrice_1" value="0">
    ...
    <div class="row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" value="0" id="totalReturn">
        </div>
        <div class="form-group col-md-4">
            <label for="cash-price">Total Add</label>
            <input type="text" class="form-control" value="0" id="totalPrice">
        </div>
        <div class="form-group col-md-4">
            <label for="cash-price">Net Amount</label>
            <input type="text" class="form-control" value="0" id="netPrice">
        </div>
    </div>
</div>
@endsection

    ...
    <script>
            ...
            $('#dataTable tbody').on( 'click', 'i.fa-trash', function () {
                ...
                function(isConfirm){   
                    if (isConfirm) {
                        $.ajax({
                            type: "POST",
                            url : "{{ route('reconciliationEntry.delete') }}",
                            ...
                            success: function(response) {
                                swal({
                                    ...
                                    type: "success",
                                    text: "Reconciliation Voucher Deleted Successfully!",
                                    timer: 1000,
                                    html: true,
                                });
                    ...
                    { 
                        swal({
                            title: "Cancelled", 
                            type: "error",
                            text: "Your Reconciliation Voucher is safe :)",
                            timer: 1000,
                            html: true,
                        });    
                    } 
        ...
        function statusChange(journalEntryId) {
            $.ajax({
                ...
                type: "post",
                url: "{{ route('reconciliationEntry.publish') }}",
                data: {journalEntryId:journalEntryId},
                success: function(response) {
                    swal({
                        title: "<small class='text-success'>Success!</small>", 

                ...
                <div class="form-group">
                    <select class="form-control chosen-select" id="dealer" name="dealer">
                        ...
                        @foreach ($dealers as $dealer)
                            @php
                                if ($dealer->id == $commission->dealer_id) {
                                    $select = 'selected';
                                } else {
                                    $select = '';
                                }
        ...
        <table class="table table-bordered table-sm" id="targetByQty">
            ...
            <tbody>
                @foreach ($commissionList as $list)
                    <tr>
                        <td>
                            <input type="hidden" name="categoryId[]" value="{{ $list->category_id }}">
                            <input type="text" class="form-control" name="categoryName[]" value="{{ $list->category_name }}"
                                readonly>
                        </td>
                        <td>
                            <input type="number" class="form-control text-right" name="commission[]" value="{{ $list->commission }}" required>
                        </td>
                    </tr>
                @endforeach

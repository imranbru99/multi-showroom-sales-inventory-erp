...
class VoucherRefuseController extends Controller {

    public function index(Request $request) {
        $title = "Voucher Refuses";
        $searchFormLink = 'voucherRefuse.index';
        $print = $request->print;
        ...
        return view('admin.voucherRefuse.index')->with(compact('title', 'searchFormLink', 'print', 'fromDate', 'toDate', 'voucherLists'));
    }
    ...
    public function view($voucherApproveId) {
        ...
        return view('admin.voucherRefuse.view')->with(compact('title', 'accountTransaction', 'accountTransactionLists'));
    }
    ...
    public function approve(Request $request) {
        ...
        if ($accountTransaction) { //change by tanmoy
            ...
            if ($view) {
                return redirect(route('voucherRefuse.view', $voucherApproveId));
                // return view('admin.voucherApprove.view')->with(compact('title','accountTransaction','accountTransactionLists'));
            }
        }

        return redirect(route('voucherRefuse.index')); //change by tanmoy
    }

...
class LeaveRequestSuggestController extends Controller {
...
//                ->where('tbl_leave_requests.showroom_id', $this->showroomId)
        ...
        return view('admin.leaveSuggession.index')->with(compact('title', 'leaverequests', 'leaverequests_suggests'));
    }

    public function getSuggestInfo(Request $request) {
    ...
    public function save(Request $request) {
        ...
        return redirect()->back()->with('msg', 'Leave Added Successfully');
    }

...
class OutOfStockController extends Controller {
    ...
    public function index(Request $request) {
        ...
        return view('admin.outOfStock.index')->with(compact('title', 'searchFormLink', 'printFormLink', 'productCategory', 'product', 'print', 'categories', 'products', 'stockOutReports', 'stores', 'storeId', 'storeIds', 'productTypes', 'type'));
    }
    ...
    public function print(Request $request) {
        ...
        $pdf = PDF::loadView('admin.outOfStock.print', ['title' => $title, 'type' => $type, 'stockOutReports' => $stockOutReports]);

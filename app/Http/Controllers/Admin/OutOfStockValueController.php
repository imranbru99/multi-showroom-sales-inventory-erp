...
class OutOfStockValueController extends Controller {

    public function index(Request $request) {
        $title = "Closing Stock By Value";
        $searchFormLink = "outOfStockValue.index";
        $printFormLink = "outOfStockValue.print";
        $print = $request->print;
        ...
        return view('admin.outOfStockValue.index')->with(compact('title', 'searchFormLink', 'printFormLink', 'productCategory', 'product', 'print', 'categories', 'products', 'stockOutReports', 'stores', 'storeId', 'storeIds', 'productTypes', 'type'));
    }
    ...
    public function print(Request $request) {
        ...
        $pdf = PDF::loadView('admin.outOfStockValue.print', ['title' => $title, 'type' => $type, 'stockOutReports' => $stockOutReports]);

        return $pdf->stream('closing_stock_by_value.pdf');
    }
    ...
    private function stockSerialQty($product, $companyId, $store_id) {
        ...
        $value = LiftingProduct::whereIn('serial_no', $notSoldSerials)->sum('amount');
...
//                    ->whereIn('store_id', $store_id)
        ...
        $value = number_format($inStock * $product->price, 2, '.', '');

...
class DebitEntryController extends Controller {
    ...
    public function index(Request $request) {
        ...
        if ($print) {
            ...
            $transactionLists = DebitEntry::select('tbl_account_transactions.*', 'view_all_account.debitHeadname as debitHeadname', 'view_all_account.creditHeadName as creditHeadName')
    ...
    public function add() {
        ...
        return view('admin.debitEntry.add')->with(compact('title', 'formLink', 'buttonName', 'showrooms', 'coas', 'creditCoas', 'voucherNo'));
    }
    ...
    public function printDebitVoucher($debitEntryId) {
        ...
        $pdf->stream('debit_voucher_' . $debitEntry->voucher_no . '.pdf');
    }

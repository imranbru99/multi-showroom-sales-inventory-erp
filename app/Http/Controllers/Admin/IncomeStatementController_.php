...
class IncomeStatementController extends Controller {
    ...
    public function index(Request $request) {
        ...
        foreach ($selectedProducts as $selectedproduct) {
            ...
            $stock = new Stock($fromDate, $toDate, $selectedproduct->id);
        ...
        return view('admin.incomeStatement.index')->with(compact('closingStockValue', 'title', 'searchFormLink', 'printFormLink', 'print', 'fromDate', 'toDate', 'incomeLists', 'data'));
    }
    ...
    public function print(Request $request) {
        ...
        $pdf = PDF::loadView('admin.incomeStatement.print', ['closingStockValue' => $closingStockValue, 'title' => $title, 'fromDate' => $fromDate, 'toDate' => $toDate, 'print' => $print, 'incomeLists' => $incomeLists, 'data' => $data], [], ['orientation' => 'P']);
